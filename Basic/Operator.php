...
var_dump($a >= 150 && $b <= 100) . '<br>'; //false && true = false
var_dump($a == 70 || $b != 30) . '<br>'; // false || true = true
var_dump($a >= 150 and $b <= 100) . '<br>'; //false and true  = false
var_dump($a == 70 or $b != 30) . '<br>'; //false or true = true
